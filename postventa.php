					...
					<div class="tile is-ancestor has-no-margin">
						<div class="tile is-parent">
							<a href="categoria.php" class="tile is-child card">
								<div class="card-content">
									...
									<h2 class="title is-4">Servicio de instalación, configuración y puesta en marcha</h2>
						...
						<div class="tile is-parent">
							<a href="categoria.php" class="tile is-child card">
								<div class="card-content">
									<!--<p>Ver productos en:</p>-->
									<h2 class="title is-4">Soporte correctivo</h2>
									<div class="hover-icon"><span class="icon"><i class="fas fa-arrow-right"></i></span></div>
								</div>
							</a>
						</div>  <!-- End Parent -->
					...
					<div class="tile is-ancestor has-no-margin">
						<div class="tile is-parent">
							<a href="categoria.php" class="tile is-child card">
								<div class="card-content">
									<!--<p>Ver productos en:</p>-->
									<h2 class="title is-4">Mantenimiento preventivo</h2>
									<div class="hover-icon"><span class="icon"><i class="fas fa-arrow-right"></i></span></div>
								</div>
							</a>
						</div>  <!-- End Parent -->
						<div class="tile is-parent">
							<a href="categoria.php" class="tile is-child card">
								<div class="card-content">
									<!--<p>Ver productos en:</p>-->
									<h2 class="title is-4">Garantía extendida</h2>
									<div class="hover-icon"><span class="icon"><i class="fas fa-arrow-right"></i></span></div>
								</div>
							</a>
						</div>  <!-- End Parent -->
